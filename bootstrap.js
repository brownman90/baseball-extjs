...
Ext.Loader.addClassPathMappings({
  "BaseballExtJS": "app",
  "BaseballExtJS.Application": "app/application.js",
  "Ext": "../../../src",
...
Ext.ClassManager.addNameAlternateMappings({
  "BaseballExtJS.Application": [],
  "BaseballExtJS.controller.Account": [],
  "BaseballExtJS.controller.Login": [],
  "BaseballExtJS.controller.Main": [],
  "BaseballExtJS.controller.Player": [],
  "BaseballExtJS.controller.Search": [],
  "BaseballExtJS.model.Player": [],
  "BaseballExtJS.model.PlayerBatting": [],
  "BaseballExtJS.model.PlayerBio": [],
  "BaseballExtJS.store.NavigationItems": [],
  "BaseballExtJS.store.PlayerBattings": [],
  "BaseballExtJS.store.Players": [],
  "BaseballExtJS.view.ChartPortlet": [],
  "BaseballExtJS.view.GridPortlet": [],
  "BaseballExtJS.view.Main": [],
  "BaseballExtJS.view.Navigation": [],
  "BaseballExtJS.view.Portal": [],
  "BaseballExtJS.view.PortalColumn": [],
  "BaseballExtJS.view.PortalDropZone": [],
  "BaseballExtJS.view.PortalPanel": [],
  "BaseballExtJS.view.Portlet": [],
  "BaseballExtJS.view.Viewport": [],
  ...
  "BaseballExtJS.view.playerComparisons.PlayerComparisonsGrid": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "BaseballExtJS.view.player.FieldingStatsTab": [
    "widget.fieldingStatsTab"
  ],
  "BaseballExtJS.view.player.PitchingStatsTab": [
    "widget.pitchingStatsTab"
  ],
  "BaseballExtJS.view.player.PlayerBattingsGrid": [
    "widget.player-battings-grid"
  ],
  "BaseballExtJS.view.player.PlayerDetail": [
    "widget.player-detail"
  ],
  "BaseballExtJS.view.player.PlayerDetailWindow": [
    "widget.player-detail-window"
  ],
  "BaseballExtJS.view.player.PlayersGrid": [
    "widget.players-grid"
  ],
  "BaseballExtJS.view.playerComparisons.PlayerComparisonsGrid": [
    "widget.player-comparisons-grid"
  ],
  "BaseballExtJS.view.search.SearchForm": [
...
Ext.setVersion("baseball-extjs-theme", "1.0.0");
