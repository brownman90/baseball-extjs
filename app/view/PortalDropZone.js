/**
 * @class BaseballExtJS.view.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link BaseballExtJS.view.PortalPanel}.
 */
Ext.define('BaseballExtJS.view.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        BaseballExtJS.view.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        BaseballExtJS.view.PortalDropZone.superclass.unreg.call(this);
    }
});
