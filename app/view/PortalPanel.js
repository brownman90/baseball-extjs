...
Ext.define('BaseballExtJS.view.PortalPanel', {
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('BaseballExtJS.view.PortalDropZone', this, this.dropConfig);
    },
